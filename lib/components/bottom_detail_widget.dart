...
class BottomDetailWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width:
          MediaQuery.of(context).size.width * 0.9, // Ekranın %90 genişliğinde
      margin: EdgeInsets.symmetric(
        horizontal: MediaQuery.of(context).size.width *
            0.05, // Her iki yandan %5 boşluk
        vertical: 20, // Üstten ve alttan 20 piksel boşluk
      ),
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(0.90),
        borderRadius:
            BorderRadius.all(Radius.circular(40)), // Kenarları yuvarlatılmış
      ),
      child: Wrap(
        children: <Widget>[
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  children: [
                    Icon(Icons.location_on,
                        color: AppColors.navyBlue, size: 35), // Marker iconu
                ...
                SizedBox(height: 20),
                Text(
                    "Konum: ${stationData.lng.toStringAsFixed(6)}, ${stationData.lat.toStringAsFixed(6)}"),
                SizedBox(height: 20),
                Row(
